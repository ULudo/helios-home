...
DEVICE_RULES = [
    ...
    ("grid_meter", ("grid", "meter", "emeter", "powermeter", "import", "export", "3em", "cls", "smgw", "gcph"), 0.86),
    ("wallbox", ("wallbox", "charger", "evcc", "evse", "charging", "easee", "zaptec", "go-e", "tesla", "mennekes"), 0.87),
